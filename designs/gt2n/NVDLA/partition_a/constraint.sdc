# ===================================================================
# NVDLA partition_a — gt2n timing constraints
# clk_period is asap7's 1265 ps scaled by minimax's asap7->gt2n ratio
# (0.867), same derivation as partition_m/partition_p. First-shot value;
# expect it to need loosening via the HighTide tightening loop
# (target = period_min * 1.10) once a build actually runs.
# ===================================================================
