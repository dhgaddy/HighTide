...
module dcache_tag_stage (
	...
	generate
		for (_gv_way_idx_1 = 0; _gv_way_idx_1 < 4; _gv_way_idx_1 = _gv_way_idx_1 + 1) begin : way_tag_gen
...
module writeback_stage (
	...
	generate
		for (_gv_byte_lane_1 = 0; _gv_byte_lane_1 < defines_CACHE_LINE_BYTES; _gv_byte_lane_1 = _gv_byte_lane_1 + 1) begin : lane_bypass_gen
...
module thread_select_stage (
	...
	generate
		for (_gv_thread_idx_3 = 0; _gv_thread_idx_3 < 4; _gv_thread_idx_3 = _gv_thread_idx_3 + 1) begin : thread_logic_gen
...
module l1_store_queue (
	...
	generate
		for (_gv_thread_idx_4 = 0; _gv_thread_idx_4 < 4; _gv_thread_idx_4 = _gv_thread_idx_4 + 1) begin : thread_store_buf_gen
...
module io_request_queue (
	...
	generate
		for (_gv_thread_idx_5 = 0; _gv_thread_idx_5 < 4; _gv_thread_idx_5 = _gv_thread_idx_5 + 1) begin : io_request_gen
...
module ifetch_tag_stage (
	...
	generate
		for (_gv_thread_idx_6 = 0; _gv_thread_idx_6 < 4; _gv_thread_idx_6 = _gv_thread_idx_6 + 1) begin : pc_logic_gen
	...
	generate
		for (_gv_way_idx_6 = 0; _gv_way_idx_6 < 4; _gv_way_idx_6 = _gv_way_idx_6 + 1) begin : way_tag_gen
...
module tlb (
	...
	generate
		for (_gv_way_idx_7 = 0; _gv_way_idx_7 < NUM_WAYS; _gv_way_idx_7 = _gv_way_idx_7 + 1) begin : way_gen
