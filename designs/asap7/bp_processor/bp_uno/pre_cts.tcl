...
# skip the clock net (CTS-0041 warnings on every single-sink net).
# Even when the flow completes the QoR is compromised by an unbuffered
# clock. Reset those buffers to NETLIST so CTS builds a real tree.
